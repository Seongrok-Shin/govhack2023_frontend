...
export default function Profile() {
  ...
  const [showChallenges, setShowChallenges] = useState(
    INITIAL_TOGGLE_STATES.CHALLENGES
  );
  ...
  return (
    <div className={styles.container}>
      <div
        className={`${styles.top_menu_bar} px-2 py-3 row justify-content-between`}
      >
        <h1 className="d-inline-block bold col-4">Profile</h1>
        <div className="col-4 text-end" onClick={logout}>
          Sign Out
        </div>
      </div>
        ...
        {showChallenges && (
          <div className="py-3">
            <p className="badge bg-success">
              {' '}
              Car-Free Commute: Use public transport, bike, walk, or carpool.
            </p>
            <p className="badge bg-success">
              {' '}
            ...
            <p className="badge bg-success">
              {' '}
              Energy-Smart Home: Use LEDs, seal drafts, and adjust thermostats.
            </p>
            <p className="badge bg-success">
              {' '}
              Reduce, Reuse, Recycle: Minimize waste, recycle, and use
              reusables.
            </p>
            <p className="badge bg-success">
              {' '}
              Unplug and Power Down: Turn off devices and lights when not in
              use.
            </p>
            <p className="badge bg-success">
              {' '}
              Minimalist Consumption: Buy fewer, quality items with less
              packaging.
            </p>
            <p className="badge bg-success">
              {' '}
              Local, Seasonal Eating: Choose locally grown and in-season foods.
            </p>
            <p className="badge bg-success">
              {' '}
              Eco-Friendly Shopping: Opt for sustainable, ethical products..
            </p>
            <p className="badge bg-success">
              {' '}
              Energy-Saving Tech: Use energy-efficient appliances and sources.
            </p>
            <p className="badge bg-success">
              {' '}
              Plant a Tree: Contribute to tree planting initiatives.
            </p>
          </div>
        )}
      </div>
